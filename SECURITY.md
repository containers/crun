...
Please do not report security vulnerabilities or security incidents via public channels (such as GitHub Issues or Pull Requests). To ensure coordinated disclosure, submit your findings via email to: [security@oci.run](mailto:security@oci.run) (not affiliated with opencontainers.org).
...
- **Email**: [security@oci.run](mailto:security@oci.run)
- **GPG key ID**: `AC404C1C0BF735C63FF4D562263D6DF2E163E1EA` ([public key](https://keys.openpgp.org/vks/v1/by-fingerprint/AC404C1C0BF735C63FF4D562263D6DF2E163E1EA))
...
- A specially crafted filesystem layout that causes crun to apply incorrect security policies.
