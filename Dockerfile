...
RUN dnf install -y git dnf-utils gcc meson ninja-build libselinux-static libseccomp-static libcap-static \
    ...
    && (cd /crun; make distclean; ./configure CFLAGS="-O3" LDFLAGS="-static-libgcc -static" LIBS="/usr/lib64/libcap.a /usr/lib64/libseccomp.a /usr/lib64/libsystemd.a /usr/lib64/libyajl_s.a /usr/lib64/libselinux.a"; make -j $(nproc))
