...
As a rarely used special case, the function may also
return a positive number on failure. `err` is not modified.
This can be used to avoid printing an error twice.
