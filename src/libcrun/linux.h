...
pid_t libcrun_run_linux_container (libcrun_container *container,
                                   int detach,
...
int libcrun_set_caps (libcrun_container *container, int keep_set_uid, libcrun_error_t *err);
...
int libcrun_linux_container_update (libcrun_container_status_t *status, const char *path, libcrun_error_t *err);
